...
model_options = {
    "Boar Model": r"C:\Users\user\sk_module1\model\boar_model.tflite",
    "Fixed Animal Model": r"C:\Users\user\sk_module1\model\fixed_animal_model.tflite"
}

# 모델 선택
selected_model = st.selectbox("Select the second model:", list(model_options.keys()))
second_model_path = model_options[selected_model]

# 동영상 업로드 또는 웹캠 선택
INPUT_MODE = st.radio("Choose Input Mode", ("Upload Video", "Use Webcam"))
...
# 모델 경로 설정
# MODEL_PATH = r"C:\Users\user\Documents\Python_Project\Module_poject\boar_model.tflite"
MODEL_PATH = r"C:\Users\user\Downloads\fixed_animal_model.tflite"

MODEL2_PATH = r"C:\Users\user\Downloads\efficientdet_lite0.tflite"
...
if st.button("Run Detection"):
    if input_path is None:
        st.error("No video file uploaded. Please upload a video file.")
    else:
